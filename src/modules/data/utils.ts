...
import type { JsonGroup, KeyTreeNode, KvEntry, DataPanelUiState, ViewMode } from "./types";
...
export function parseDataPanelUiState(value: unknown): DataPanelUiState | null {
  if (!value || typeof value !== "object") return null;
  const state = value as Partial<DataPanelUiState>;
