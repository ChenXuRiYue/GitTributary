...
- ✅ **T4 · `PluginHeader` 三段式约定**: 写入 `doc/UI/插件顶栏规范.md`，供全插件复用。
...
- 2026-07-04: 完成 T1 (术语全量替换)、T2 (筛选精简)、T3 (顶栏瘦身)、T4 (`doc/UI/插件顶栏规范.md`)；`tsc --noEmit` 通过，站点插件无残留旧术语。对象命名按 "发布任务" 落地 (D1 视为采纳，可回退)。
