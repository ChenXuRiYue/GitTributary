...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            crate::application::data::commands::store_list_profiles,
            crate::application::data::commands::store_list_environments,
            crate::application::data::commands::store_active_profile,
            crate::application::data::commands::store_active_environment,
            crate::application::data::commands::store_switch_profile,
            crate::application::data::commands::store_switch_environment,
            crate::application::data::commands::store_create_profile,
            crate::application::data::commands::store_create_environment,
            crate::application::data::commands::store_delete_profile,
