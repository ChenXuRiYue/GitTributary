...
use na_git::{repo_dir_name_from_url, ChangeKind, CommitIdentity, GitRepo};
...
fn test_repo_dir_name_from_url() {
    assert_eq!(
        repo_dir_name_from_url("https://github.com/ChenXuRiYue/na-test.git").unwrap(),
        "na-test"
    );
    assert_eq!(
        repo_dir_name_from_url("https://github.com/ChenXuRiYue/na-test/").unwrap(),
        "na-test"
    );
    assert_eq!(
