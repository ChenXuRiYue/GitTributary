...
把 Git 留痕、GitHub 备份、变更查看、提交管理、远程同步和高频辅助模块组织成一个干净的本地工具。
...
- 模块化能力为复习、AI、模板、自动化、发布等工作流留下扩展空间。
...
- **模块化架构**：一级模块和 Git 二级视图都通过注册表驱动，便于继续扩展。
...
commit management, remote sync, and high-frequency helper modules.
...
- Leave room for modules such as review, AI, templates, automation, and publishing.
...
- **Modular architecture**: top-level modules and Git subviews are registry-driven for future growth.
